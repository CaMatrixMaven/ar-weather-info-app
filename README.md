...
A lightweight browser-based augmented reality weather overlay app that opens the device camera, displays
a small AR-style Panel overlay, and shows live weather (temperature + humidity) for the user’s current location.
...
- Placeholder model ** rendered in overlay
...
- Friendly weather error message.
